void Edep_Ratio_SingleLayer()
{
    ...
    TCut HET = "(L0_E>0.23 && L1_E >0.23 && L2_E>0.23 && L3_E>0.046) && log10(Total_E)>2.0 && log10(Total_E)<=2.2";
    ...
    proton_tree->Draw("log10(L5_E/Total_E)>>h1_p",HET,"");
    deuteron_tree->Draw("log10(L5_E/Total_E)>>h1_d",HET,"");
    electron_tree->Draw("log10(L5_E/Total_E)>>h1_e",HET,"");
    helium4_tree->Draw("log10(L5_E/Total_E)>>h1_h",HET,"");
    helium3_tree->Draw("log10(L5_E/Total_E)>>h1_H",HET,"");
    ...
    legend1->Draw();       
    c1->SaveAs("/Users/xiongzheng/software/B4/B4c/Script/EnergyLong/Edep_Ratio_SingleLayer_16_50_84.pdf");
    ...
    c2->SaveAs("/Users/xiongzheng/software/B4/B4c/Script/EnergyLong/Edep_Ratio_SingleLayer_logNormal.pdf");
