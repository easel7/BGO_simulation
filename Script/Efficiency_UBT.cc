void Efficiency_UBT()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        ...
        proton_tree->Draw(Form("Total_E/Energy>>h4_p[%d]",i), MIT,"");
        ...
        deuteron_tree->Draw(Form("Total_E/Energy>>h4_d[%d]",i), MIT,"");
        ...
        helium4_tree->Draw(Form("Total_E/Energy>>h4_h[%d]",i),  MIT,"");
        ...
        helium3_tree->Draw(Form("Total_E/Energy>>h3_H[%d]",i),  MIT,"");
        ...
        carbon_tree->Draw(Form("Total_E/Energy>>h4_c[%d]",i),  MIT,"");
