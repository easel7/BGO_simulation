void Edep_Ratio()
{
    ...
    for (int i = 0; i < 13; i++)
    {
        ...
        c1->SaveAs( Form("/Users/xiongzheng/software/B4/B4c/Script/Matrix/EnergyDeposit_%dGeV.pdf",int(Energy[i])) );
    ...
    c0->SaveAs("/Users/xiongzheng/software/B4/B4c/Script/Matrix/EnergyDeposit.pdf");
