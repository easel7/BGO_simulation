void CrossSection_EM()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        ...
        c1->SaveAs( Form("/Users/xiongzheng/software/B4/B4c/Script/CrossS/CrossSection_EM_%dGeV.pdf",int(Energy[i])) );
    }
    ...
    c0->SaveAs("/Users/xiongzheng/software/B4/B4c/Script/CrossS/CrossSection_EM.pdf");
