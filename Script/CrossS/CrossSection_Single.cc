...
{
    auto file = TFile::Open("/Users/xiongzheng/software/B4/B4c/build/B4_proton.root");
    ...
    TCut HI  = "First_Had_Depth>=0 && First_Had_Type==2";
    ...
    TF1 *fitFunc0 = new TF1("fitFunc0", "[0]*exp(-x/[1])", 0, 60);
    TF1 *fitFunc1 = new TF1("fitFunc1", "[0]*exp(-x/[1])", 0, 200);
    ...
    latex.DrawLatex(5,3,"Fitting Function: P=[0]*exp(-x/[1])");
    ...
    cout << "EM Interaction Constant: " << constant0  << ",EM Lambda: " << lambda0 << " mm, EM Lambda_err = " << lambda0_err << " mm " << endl;
    cout << "Nuclear Collsion Constant: " << constant1  << ",HD Lambda: " << lambda1 << " mm, HD Lambda_err = " << lambda1_err << " mm " << endl;
    cout << "Nuclear Interaction Constant: " << constant1  << ",HI Lambda: " << lambda2 << " mm, HI Lambda_err = " << lambda2_err << " mm " << endl;
